    ...
    let toggleBanner = toogleMenu ? (<div className={css.banner}>
        ...
        <div className={css.bannerInner}>
            ...
            <div className={css.bannerTxt}>
                <div className={css.title}>FOOD Delivery</div>
                <div className={css.tag}>Find the best restaurants, cafés and bars in India <span className={css.bld}>India </span></div>
                <div><span className={css.bld}>Developed by FAISAL</span></div>
