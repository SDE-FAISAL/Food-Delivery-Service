    ...
    return <div className={footerCss.footer}>
        <div className={footerCss.innerFooter}>
            <div className={footerCss.sec1}>
                <div className={footerCss.logoBox}>FoodDelivery</div>
            ...
            <div className={footerCss.sec2}>
                <div className={[footerCss.box1, footerCss.box].join(' ')}>
                    <div className={footerCss.boxTtl}>ABOUT Food Delivery</div>
                ...
                <div className={[footerCss.box2, footerCss.box].join(' ')}>
                    <div className={footerCss.boxTtl}>FOODVERSE</div>
                    <a href="" className={footerCss.boxOpt}>Food Delivery</a>
                    <a href="" className={footerCss.boxOpt}>Feeding India</a>
                    <a href="" className={footerCss.boxOpt}>Hyperpure</a>
                    <a href="" className={footerCss.boxOpt}>Foodland</a>
                </div>
                ...
                <div className={[footerCss.box5, footerCss.box].join(' ')}>
                    ...
                    <div className={footerCss.socialImgs}>
                        ...
                        <a href="https://www.linkedin.com/in/faisal-076a94182" target='_blank' className={footerCss.socialImgAnchore} >
            ...
            <div className={footerCss.sec3}>
                By continuing past this page, you agree to our Terms of Service, Cookie Policy, Privacy Policy and Content Policies. All trademarks are properties of their respective owners. 2008-2022 © FAISAL™ Ltd. All rights reserved.
            </div>
        </div>
    </div>
}
