...
let Login = ({ setAuth, setLoggedIn }) => {
    ...
    let loginDiv = !otpModal ? <div className={loginCss.outerDiv}>
        <div className={loginCss.modal}>
            ...
            <div className={loginCss.newToZomato}>New to food-delivery? <div className={loginCss.createAcc} onClick={() => setAuth({ closed: false, login: false, signup: true })}>Create Account</div></div>
        </div>
